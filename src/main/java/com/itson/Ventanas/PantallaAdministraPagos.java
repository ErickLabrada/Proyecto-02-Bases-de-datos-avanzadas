 ...
 * @author Erick
 */
public class PantallaAdministraPagos extends javax.swing.JFrame {

    static PantallaSeleccionaTramite seleccionTramite;
    
    /**
     * Creates new form PantallaAdministraPagos
     */
    public PantallaAdministraPagos() {
        initComponents();
        seleccionTramite = new PantallaSeleccionaTramite();
    ...
    private void initComponents() {
        ...
        btmEfectuarPago = new javax.swing.JButton();
        btnCancelarPago = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Roboto Black", 0, 18)); // NOI18N
        jLabel1.setText("Administrador de pagos");

        btmEfectuarPago.setText("Efectuar pago");
        btmEfectuarPago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmEfectuarPagoActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(18, 18, 18)
                .addComponent(btmEfectuarPago, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaAdministraPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaAdministraPagos().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btmEfectuarPago;
