...
public class PersonaDAO implements IPersonaDAO {
    ...
    /**
     * Método que le agrega un objeto de tipo tramite a una persona. Arroja una
     * excepción del tipo "ProcedureNotFoundException" si el procedimiento no
     * existe.
     *
     * @param entityManager
     * @param persona
    ...
    public void addTramite(EntityManager entityManager, Persona persona, Tramite tramite) throws ProcedureNotFoundException {
        ...
        if (tramite != null) {
            ...
            throw new ProcedureNotFoundException("El tramite que desea agregar no existe");
        }
    }
     ...
     * personas registradas en la base de datos que cumplan con los parámetros
